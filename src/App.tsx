    ...
    <main className="p-14 max-md:px-8 space-y-16 max-md:space-y-10">
        ...
        <section className="flex max-md:flex-col-reverse max-md:space-x-0 max-md:space-y-7 items-center justify-between space-x-8">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-4xl max-md:text-2xl font-bold tracking-wide max-md:text-center">Transforming Ideas into Powerful Solutions</h1>
        ...
        <section className="flex max-md:flex-col items-center justify-between gap-10">
          ...
          <div className=" md:w-1/2">
            <img className="rounded-md shadow-md scale-90 transition-all hover:scale-95" src="https://images.unsplash.com/photo-1708556863286-16a9ada29871?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="feature" />
          </div>
          ...
          <div className="md:w-1/2 space-y-10">
            {Features.map(feature =>(
              <div className="space-y-5 max-md:text-center" key={feature.label}>
                <h1 className="text-3xl max-md:text-xl font-bold">{feature.label}</h1>
          ...
          <div className="space-y-8 max-md:text-center">
            {Supports.map(support => (
              <div className="space-y-5">
                <h1 className="text-3xl font-bold max-md:text-2xl">{support.label}</h1>
                <hr />
                <p className="text-sm font-medium text-neutral-500 max-md:text-xs">{support.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="space-y-8">
          ...
          <div className="space-y-5 text-center">
            ...
            <p className="font-medium text-neutral-500 max-md:text-sm">We have offices worldwide to serve you better.</p>
          </div>
            ...
            <CarouselNext className="md:hidden" />
              <CarouselContent>
                {Locations.map(location => (
                  <CarouselItem key={location.label} className="basis-1/4 max-md:basis-full pl-4 space-y-6 text-center">
                    ...
                    <Link className="font-medium hover:text-purple-600 transition-all underline" to={'#'}>Get directions</Link>
                  </CarouselItem>
                ))}
              </CarouselContent>
        ...
        <section className="flex flex-col items-center space-y-6 justify-between">
          <div className="space-y-6 text-center">
            <h1 className="text-5xl font-bold max-md:text-3xl">Frquently Asked Questions</h1>
            <p className="font-medium text-neutral-500 max-md:text-sm">Find answers to common questions about our company and solutions.</p>
          </div>

          <div className="space-y-6 transition-all">
            {FAQs.map(faq => (
              <Collapsible className="transition-all space-y-5 relative w-[70vw] border-2 p-6 max-md:p-4 border-black">
