  ...
  return (
    <main className="w-full h-full p-16 max-md:px-8">
      <section className="flex flex-col gap-10 max-md:text-center">
        ...
        <div className="flex justify-between gap-10 items-center max-md:flex-col-reverse">
          <div className="md:w-1/2 tracking-tight leading-relaxed text-lg font-medium text-slate-600 max-md:text-base">
            <p>
