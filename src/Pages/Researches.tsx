      ...
      <section className="flex items-center max-md:flex-col-reverse justify-center space-x-8 *:w-1/2 max-md:*:w-full max-md:space-x-0 max-md:gap-10">
        <div className="space-y-8 max-md:space-y-6 max-md:text-center">
          <h1 className="font-bold text-4xl max-md:text-2xl">
            Simplify Your Research Process with Our Long Heading Feature
          </h1>
          <p className="font-medium text-neutral-600 max-md:text-sm">
            Our software is designed to streamline the research process, making
            it easier and more efficient for researchers.
          </p>
          <div className="flex *:w-1/2 items-center justify-between space-x-7 *:space-y-5">
            <PercentBox text="Save time and effort with our powerful research tools." />
            <PercentBox text="Access valuable insights and make informed decisions." />
          </div>
        </div>

        <div className="">
          <img
            className="rounded-md scale-100 transition-all"
